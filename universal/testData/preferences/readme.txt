...
sammy likes bigfont, black white
...
2)	User1 - Sammy (token sammy) is visually impaired and wants contrast set to yellow on black, 
font size and button size as big as possible, likes font face Comic Sans, and speaks German. 
...
application ID??
transformations only needed when common terms are referenced.
language transformation not needed if short identifiers used. 
